    ...
    <div data-cmp="Hosts" className="space-y-6 p-6">
      ...
      {(canReadAgents || canManageAgents) && (
        ...
        >
          ...
          {canManageAgents && (
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-[1fr_1.4fr_1fr_auto_auto_auto]">
              <input
              ...
              <input
                ...
                onChange={event =>
                  setAgentForm(form => ({ ...form, endpoint: event.target.value }))
                }
                ...
                >
                  <div className="mb-5 flex items-start justify-between">
                    <div>
                      ...
                      <div className="font-mono text-xs" style={{ color: 'var(--kvm-text-muted)' }}>
                        {host.hostname || host.address} · {host.address}
                      </div>
                    </div>
                    <div className="text-right text-xs" style={{ color: 'var(--kvm-text-muted)' }}>
                      <div
