...
export default function SettingsPage() {
  ...
  return (
    <SettingsPageFrame>
      ...
      {tab === "notifications" && (canReadNotifications || canManageNotifications) && <SettingsConfigSection title="通知媒介" description="站内告警通过右上角通知中心查看，外部媒介启用后会接收活跃告警、恢复通知推送；也可用于找回密码。" badge={<SettingsSectionBadge icon={MegaphoneIcon} label="告警通知" />}>
