      ...
      <div className="kvm-dialog-panel flex h-[min(88vh,760px)] w-[min(92vw,980px)] flex-col overflow-hidden rounded-2xl shadow-2xl">
        ...
        >
          <div className="min-w-0">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-x-2.5 gap-y-0.5 text-[11px]" style={{ color: 'var(--kvm-text-muted)' }}>
              <span
        ...
        <main className="flex min-h-0 flex-1 flex-col overflow-hidden p-4" style={{ background: 'var(--kvm-control-bg-soft)' }}>
          ...
          <div
            ...
            style={{ boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.08), 0 18px 40px rgba(15,23,42,0.16)' }}
          >
