...
import { CableIcon, CpuIcon, Disc3Icon, FileCode2Icon, InfoIcon, XIcon } from 'lucide-react';
import {
  fetchVMConfig,
  type VMConfig,
  type VMConfigDisk,
        ...
        <div className="kvm-dialog-panel flex max-h-[88vh] w-[min(92vw,920px)] flex-col overflow-hidden rounded-2xl shadow-2xl">
          ...
          >
            <div className="kvm-dialog-card rounded-2xl p-4">
              ...
              {activeTab === 'media' && (
                <MediaPanel vm={vm} config={config} onConfigChange={handleConfigChange} />
              )}
              {activeTab === 'devices' && (
                <DevicesPanel
                  vm={vm}
...
function mergeConfigDiskCapacities(
  nextConfig: VMConfig,
