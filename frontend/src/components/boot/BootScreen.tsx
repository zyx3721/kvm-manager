...
export default function BootScreen() {
  ...
  return (
    ...
    >
      ...
      <div className="kvm-login-orb absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full" aria-hidden="true" />
      <div className="relative flex flex-col items-center gap-5">
        <div className="kvm-boot-ring flex flex-col items-center justify-center gap-2">
          <img className="kvm-boot-icon h-20 w-20" src={baseConfig.iconData} alt={baseConfig.siteName} />
        ...
        <div className="text-center">
          ...
          <div className="mt-1 text-xs uppercase tracking-[0.28em]" style={{ color: "var(--kvm-text-muted)" }}>
            正在启动控制台
          </div>
        </div>
      </div>
