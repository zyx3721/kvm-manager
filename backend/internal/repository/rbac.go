...
var BuiltinPermissions = []domain.Permission{
	...
	{Key: "operations.read", Name: "查看运维记录", Description: "查看任务、审计、告警和通知投递历史", Category: "任务 / 审计 / 告警"},
	{Key: "alerts.manage", Name: "处理告警状态", Description: "解决告警、标记通知已读和清空通知中心", Category: "任务 / 审计 / 告警"},
